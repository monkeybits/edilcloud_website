...
function adfoin_sendinblue_settings_view( $current_tab ) {
    ...
    <form name="sendinblue_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <p class="description" id="code-description"><a
                            ...
                            target="_blank"><?php _e( 'Click here to get API Key.', 'forms-to-sendinblue' ); ?></a> <?php _e( 'Use V3 key', 'forms-to-sendinblue' ); ?></p>
                </td>
            </tr>
        </table>
        <?php submit_button(); ?>
