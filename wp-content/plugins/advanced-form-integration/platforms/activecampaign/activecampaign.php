...
function adfoin_activecampaign_settings_view( $current_tab ) {
    ...
    <form name="activecampaign_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_activecampaign_url"
                           value="<?php echo $url; ?>" placeholder="<?php _e( 'Please enter URL', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                    <p>
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_activecampaign_api_key"
                           value="<?php echo $api_key; ?>" placeholder="<?php _e( 'Please enter Key', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                    <p>
    ...
    <script type="text/template" id="activecampaign-action-template">
        <table class="form-table">
            ...
            <tr valign="top" class="alternate" v-if="action.task == 'subscribe'">
                ...
                <td>
                    <select name="account_id" v-model="fielddata.accountId">
            ...
            <tr valign="top" class="alternate" v-if="action.task == 'subscribe'">
                ...
                <td>
                    <select name="list_id" v-model="fielddata.listId">
            ...
            <tr valign="top" class="alternate" v-if="action.task == 'subscribe'">
                ...
                <td>
                    <select name="automation_id" v-model="fielddata.automationId">
            ...
            <tr valign="top" class="alternate" v-if="action.task == 'subscribe'">
                ...
                <td>
                    <input type="checkbox" name="update" v-model="fielddata.update">
                </td>
            </tr>
