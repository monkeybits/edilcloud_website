            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_campaignmonitor_api_token"
                           ...
                           class="regular-text"/>
                    <p>
                        <?php _e( 'Go to Account Settings > API Keys', 'advanced-form-integration' ); ?>
                    </p>
                </td>
            </tr>
        </table>
    ...
    <script type="text/template" id="campaignmonitor-action-template">
        <table class="form-table">
            ...
            <tr class="alternate" v-if="action.task == 'create_subscriber'">
                ...
                <td>
                    <select name="account" v-model="fielddata.accountId" required="true" @change="getList">
            ...
            <tr class="alternate" v-if="action.task == 'create_subscriber'">
                ...
                <td>
                    <select name="list" v-model="fielddata.listId" required="true">
                        <option value=""><?php _e( 'Select...', 'advanced-form-integration' ); ?></option>
