...
function adfoin_elasticemail_settings_view( $current_tab ) {
    ...
    <form name="elasticemail_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
        ...
        <table class="form-table">
            <tr valign="top">
                <th scope="row"> <?php _e( 'Elastic Eamil API Key', 'advanced-form-integration' ); ?></th>
                <td>
                    <input type="text" name="adfoin_elasticemail_api_key"
                           ...
                           class="regular-text"/>
                    <p class="description" id="code-description"><?php _e( 'Please go to Settings > API then create API Key', 'advanced-form-integration' ); ?></a></p>
                </td>
            </tr>
        </table>
        <?php submit_button(); ?>
