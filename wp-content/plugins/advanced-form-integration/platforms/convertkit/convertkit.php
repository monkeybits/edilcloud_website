            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_convertkit_api_key"
                           ...
                           class="regular-text"/>
                    <p class="description" id="code-description"><?php _e( 'Please go to Account Settings to get API Key', 'advanced-form-integration' ); ?></a></p>
                </td>
            </tr>
        </table>
        <?php submit_button(); ?>
    ...
    <script type="text/template" id="convertkit-action-template">
        <table class="form-table">
            ...
            <tr valign="top" class="alternate" v-if="action.task == 'subscribe'">
                <td scope="row-title">
                    <label for="tablecell">
                        <?php esc_attr_e( 'ConvertKit Sequence', 'advanced-form-integration' ); ?>
                    </label>
                </td>
                <td>
