    ...
    <script type="text/template" id="webhook-action-template">
        <table class="form-table">
            ...
            <tr class="alternate" v-if="action.task == 'send_to_webhook'">
                ...
                <td>
                    <input type="text" class="regular-text" v-model="fielddata.webhookUrl" name="webhook_url" placeholder="<?php _e( 'Enter URL here', 'advanced-form-integration'); ?>" required="required">
                </td>
            </tr>
        </table>
    </script>
