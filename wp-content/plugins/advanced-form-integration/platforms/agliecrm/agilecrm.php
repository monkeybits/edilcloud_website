...
function adfoin_agilecrm_settings_view( $current_tab ) {
    ...
    <form name="agilecrm_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                <th scope="row"> <?php _e( 'REST API Key', 'advanced-form-integration' ); ?></th>
                <td>
            ...
            <tr valign="top">
                <th scope="row"> <?php _e( 'User Eamil', 'advanced-form-integration' ); ?></th>
                <td>
                    <input type="text" name="adfoin_agilecrm_email"
                           value="<?php echo $email; ?>" placeholder="<?php _e( 'Please enter User Eamil', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
...
add_action( 'admin_post_adfoin_save_agilecrm_api_key', 'adfoin_save_agilecrm_api_key', 10, 0 );
...
add_action( 'adfoin_add_js_fields', 'adfoin_agilecrm_js_fields', 10, 1 );
    ...
    <script type="text/template" id="agilecrm-action-template">
        <table class="form-table">
            ...
            <tr valign="top" v-if="action.task == 'add_contact'">
                ...
                <td scope="row">
                    <span><?php printf( __( 'To unlock tags & custom fields consider <a href="%s">upgrading to Pro</a>.', 'advanced-form-integration' ), admin_url('admin.php?page=advanced-form-integration-settings-pricing') ); ?></span>
                </td>
            </tr>
        </table>
    </script>
