...
function adfoin_mailerlite_settings_view( $current_tab ) {
    ...
    <form name="mailerlite_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
        ...
        <table class="form-table">
            <tr valign="top">
                <th scope="row"> <?php _e( 'MailerLite API Key', 'advanced-form-integration' ); ?></th>
                <td>
                    <input type="text" name="adfoin_mailerlite_api_key"
                           ...
                           class="regular-text"/>
                    <p class="description" id="code-description"><?php _e( 'Please go to Integrations > Developer API to get API Key', 'advanced-form-integration' ); ?></a></p>
                </td>
            </tr>
        </table>
        <?php submit_button(); ?>
...
add_action( 'admin_post_adfoin_save_mailerlite_api_key', 'adfoin_save_mailerlite_api_key', 10, 0 );
