...
function adfoin_omnisend_settings_view( $current_tab ) {
    ...
    <form name="omnisend_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_omnisend_api_token"
                           ...
                           class="regular-text"/>
                    <p class="description" id="code-description"><?php _e( 'Please go to Store Settings > Integrations & API > API Keys to get API Key', 'advanced-form-integration' ); ?></a></p>
                </td>
...
add_action( 'admin_post_adfoin_save_omnisend_api_token', 'adfoin_save_omnisend_api_token', 10, 0 );
...
add_action( 'adfoin_add_js_fields', 'adfoin_omnisend_js_fields', 10, 1 );
