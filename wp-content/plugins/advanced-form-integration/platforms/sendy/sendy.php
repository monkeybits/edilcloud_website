...
function adfoin_sendy_settings_view( $current_tab ) {
    ...
    <form name="sendy_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                <th scope="row"> <?php _e( 'Installation URL', 'advanced-form-integration' ); ?></th>
                <td>
                    <input type="text" name="adfoin_sendy_url"
                           value="<?php echo $url; ?>" placeholder="<?php _e( 'Please enter Sendy Installation URL', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                </td>
    ...
    <script type="text/template" id="sendy-action-template">
        <table class="form-table">
            ...
            <tr valign="top" class="alternate" v-if="action.task == 'subscribe'">
                ...
                <td>
                    <input  name="list_id" type="text" v-model="fielddata.listId"  required="required">
