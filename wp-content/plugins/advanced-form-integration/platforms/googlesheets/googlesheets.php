...
class ADFOIN_GoogleSheets extends Advanced_Form_Integration_OAuth2 {
    ...
    private function __construct() {
        ...
        add_action( 'adfoin_custom_script', array( $this, 'custom_script' ) );
        ...
        add_action( 'admin_post_adfoin_save_googlesheets_keys', array( $this, 'adfoin_save_googlesheets_keys' ), 10, 0 );
    ...
    public function custom_script() {
        wp_enqueue_script( 'adfoin-googlesheets-script', ADVANCED_FORM_INTEGRATION_URL . '/platforms/googlesheets/script.js', array( 'adfoin-vuejs' ), '', 1 );
    }
    ...
    public function adfoin_googlesheets_settings_view( $current_tab ) {
        ...
        <form name="googlesheets_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td>
                        <p>
                            <?php _e( '1. Go to <a target="_blank" href="https://console.developers.google.com/">Google Developer Console</a> and create a <b>New Project</b><br>
                                      ...
                                      <?php printf( __( '4. Go to <b>OAuth consent screen</b>, put anything on <b>Applicatoin name</b>, enter <code><i>%s</i></code> in <b>Authorized domains</b> then click <b>Save</b> button below.<br>', 'advanced-form-integration' ), $host ) ?>
                                      ...
                                      <?php _e( '(You can also check this video instruction <a target="_blank" href="https://youtu.be/Q6x2dopJpfE">https://youtu.be/Q6x2dopJpfE</a>)', 'advanced-form-integration' ); ?>
                        </p>
                    </td>
                </tr>
                <tr valign="top">
...
//        advanced_form_integration_redirect( "admin.php?page=advanced-form-integration-settings&tab=googlesheets" );
        ...
        <script type="text/template" id="googlesheets-action-template">
            <table class="form-table">
                ...
                <tr valign="top" class="alternate" v-if="action.task == 'add_row'">
                    ...
                    <td>
                        <select name="spreadsheetId" v-model="fielddata.spreadsheetId" @change="getWorksheets" required="required">
                ...
                <tr valign="top" class="alternate" v-if="action.task == 'add_row'">
                    ...
                    <td>
                        <select name="worksheetId" v-model="fielddata.worksheetId" @change="getHeaders" required="required">
    ...
    public function get_spreadsheet_list() {
        ...
        $endpoint = "https://www.googleapis.com/drive/v3/files?q=mimeType%20%3D%20'application%2Fvnd.google-apps.spreadsheet'&access_token=" . $this->access_token;
    ...
    public function append_new_row( $spreadsheet_id = '', $worksheet_name = '', $data_array = '', $record ) {
...
function adfoin_googlesheets_send_data( $record, $posted_data ) {
    ...
    if( $task == "add_row" ) {
        ...
        if ( !empty( $holder ) ) {
            $googlesheets = ADFOIN_GoogleSheets::get_instance();
            $googlesheets->append_new_row( $spreadsheet_id, $worksheet_name, $holder, $record );
        }
    }
