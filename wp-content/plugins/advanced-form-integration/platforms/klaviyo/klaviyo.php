...
function adfoin_klaviyo_settings_view( $current_tab ) {
    ...
    <form name="klaviyo_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <p class="description" id="code-description"><a
                            ...
                            target="_blank"><?php _e( 'Click here to create API Key', 'advanced-form-integration' ); ?></a></p>
                </td>
            </tr>
        </table>
        <?php submit_button(); ?>
