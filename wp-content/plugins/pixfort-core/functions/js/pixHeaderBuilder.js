(function ( $ ) {
	...
	jQuery(document).ready(function($) {
		...
		var url = plugin_object.PIX_CORE_PLUGIN_URI;
		var elms = [];
		...
		function init_el_settings(el){
			...
			if(type=="col_area"){
				options.push({
					...
					val: "text-left",
					options: { "text-left": "Left", "text-center": "Center", "text-right": "Right", "d-flex": "Justify content between"}
				});
			}
