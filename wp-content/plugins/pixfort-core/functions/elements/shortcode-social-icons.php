...
vc_map( array (
    ...
    'params' 		=> array (
        ...
        array (
            ...
            'type' 			=> 'textfield',
            'heading' 		=> __('Custom Icon Size', 'pix-opts'),
        ...
        array (
            ...
            'description' 	=> __('Select the position of the icons.', 'pix-opts'),
            'admin_label'	=> false,
            "std"           => "center",
            'value'			=> array_flip(array(
                'text-left'			=> 'Left',
        ...
        array (
            ...
            'type' 			=> 'dropdown',
            'heading' 		=> __('Padding', 'pix-opts'),
            'description' 	=> __('Select the padding between the icons.', 'pix-opts'),
            'admin_label'	=> false,
            "std"           => "center",
            'value'			=> array_flip(array(
                'px-2'			=> 'Default (small)',
        ...
        array (
            ...
            'type' 			=> 'textfield',
            'heading' 		=> __('Custom Icons padding', 'pix-opts'),
            "description" => __( "Please input the value (with the unit: px,.. etc).", "pix-opts"),
            'admin_label'	=> false,
            "dependency" => array(
                  "element" => "padding",
