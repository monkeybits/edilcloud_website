...
vc_add_params('vc_section', array(
    ...
    array (
        ...
        'type' 			=> 'textfield',
        'heading' 		=> __('Section name', 'pix-opts'),
        'admin_label'	=> true,
    ),
    ...
    array (
        ...
        'type' 			=> 'attach_image',
        'heading' 		=> __('Fade in Background Image', 'pix-opts'),
        'admin_label'	=> false,
    ...
    array (
        ...
        'type' 			=> 'dropdown',
        'heading' 		=> __('Section Scale In effect', 'pix-opts'),
    ...
    array (
        ...
        'params' => array(
            ...
            array(
                'type'        => 'colorpicker',
                'heading'     => esc_html__('Layer color', 'pix-opts'),
                'param_name'  => 'd_color_1',
                'value'       => '#f8f9fa',
            ),
            array(
                'type'        => 'colorpicker',
                'heading'     => esc_html__('Layer color 2', 'pix-opts'),
    ...
    array(
        'type'        => 'colorpicker',
        'heading'     => esc_html__('Layer 1 color', 'pix-opts'),
    ...
    array(
        'type'        => 'colorpicker',
        'heading'     => esc_html__('Layer 1 second gradient color', 'pix-opts'),
    ...
    array (
        ...
        'description' 	=> __('Select the animation of the layer.', 'pix-opts'),
        'admin_label'	=> false,
        'value'			=> $animations,
        "group"	=> "Bottom Dividers",
        "dependency" => array(
    ...
    array(
        'type'        => 'colorpicker',
        'heading'     => esc_html__('Layer 2 color', 'pix-opts'),
    ...
    array(
        'type'        => 'colorpicker',
        'heading'     => esc_html__('Layer 2 second gradient color', 'pix-opts'),
    ...
    array(
        'type'        => 'colorpicker',
        'heading'     => esc_html__('Layer 3 color', 'pix-opts'),
    ...
    array(
        'type'        => 'colorpicker',
        'heading'     => esc_html__('Layer 3 second gradient color', 'pix-opts'),
    ...
    array (
        ...
        'type' 			=> 'textfield',
        'heading' 		=> __('Divider custom height (Optional)', 'pix-opts'),
    ...
    array (
        ...
        'type' 			=> 'dropdown',
        'heading' 		=> __('Background Image Overlay color', 'pix-opts'),
    ...
    array(
        'type'        => 'colorpicker',
        'heading'     => esc_html__('Custom overlay color', 'pix-opts'),
