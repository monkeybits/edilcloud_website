...
vc_map( array(
    ...
    'description' 	=> __('Add accordion to organize content', 'pix-opts'),
    "is_container" => true,
    "group"		=> "test",
    ...
    "params" => array(
        array(
            ...
            'heading' => esc_html__( 'Accordion ID', 'js_composer' ),
            'description' => sprintf( esc_html__( 'Enter accordion ID (Note: make sure it is unique and valid according to %sw3c specification%s).', 'js_composer' ), '<a href="https://www.w3schools.com/tags/att_global_id.asp" target="_blank">', '</a>' ),
        ),
        array(
            'type' => 'css_editor',
...
vc_map(array(
    'name' => esc_html__( 'Pix Accordion Tab', 'js_composer' ),
    'base' => 'pix_accordion_tab',
    'class'         => 'pixfort_element',
    'icon' 			=> PIX_CORE_PLUGIN_URI . 'functions/images/elements/accordion-tab.png',
    'description' 	=> __('Add new accordion tab', 'pix-opts'),
    'is_container' => true,
    "content_element" => true,
    'show_settings_on_create' => false,
    'as_child' => array(
    ...
    'description' => esc_html__( 'Section for Accordions.', 'js_composer' ),
    'params' => array(
        ...
        array (
            ...
            'type' 			=> 'colorpicker',
            'heading' 		=> __('Icon Color', 'pix-opts'),
            'description' 	=> __('This option only work with default icon type.', 'pix-opts'),
            'admin_label'	=> false,
            "group"	      => "Advanced",
            "dependency" => array(
                "element" => "icon_color",
