...
$button_params = array (
    ...
    array (
        'param_name' 	=> 'btn_link',
        'type' 			=> 'textfield',
        'heading' 		=> __('Button Link', 'pix-opts'),
        'admin_label'	=> false,
    ),
    array(
        "type" => "checkbox",
    ...
    array (
        ...
        'type' 			=> 'dropdown',
        'heading' 		=> __('Button Color', 'pix-opts'),
        'admin_label'	=> true,
        'value'			=> array_flip(array(
            'primary' 		=> 'Primary',
    ...
    array (
        ...
        'type' 			=> 'dropdown',
        'heading' 		=> __('Button Text Align', 'pix-opts'),
        'admin_label'	=> false,
        'value'			=> array_flip(array(
            'text-center' 		=> 'Center',
            'text-left' 		=> 'Left',
    ...
    array (
        'param_name' 	=> 'btn_div',
        'type' 			=> 'dropdown',
        'heading' 		=> __('Button inside a container', 'pix-opts'),
