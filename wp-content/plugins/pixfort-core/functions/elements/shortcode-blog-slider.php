...
vc_map( array (
    ...
    'name' 			=> __('Blog Carousel', 'pix-opts'),
    'category' 		=> __('pixfort', 'pix-opts'),
    "weight"	=> "1000",
    'class'         => 'pixfort_element',
    'icon' 			=> PIX_CORE_PLUGIN_URI . 'functions/images/elements/blog-carousel.png',
    'description' 	=> __('Add slick posts carousel', 'pix-opts'),
    'params' 		=> array_merge(
        array (
            array (
                'param_name' 	=> 'count',
                'type' 			=> 'textfield',
                'heading' 		=> __('Posts count', 'pix-opts'),
                'description' 	=> __('Number of posts to show', 'pix-opts'),
                'admin_label'	=> false,
                'value'	        => 5,
            ),
            array (
                ...
                'description' 	=> __('Select posts category.', 'pix-opts'),
                'admin_label'	=> false,
            ...
            array (
                ...
                'type' 			=> 'textfield',
                'heading' 		=> __('Multiple Categories', 'pix-opts'),
                'description' 	=> __('Categories Slugs should be separated with <strong>coma</strong> (,)', 'pix-opts'),
                'admin_label'	=> false,
            ),
            ...
            array (
                ...
                'type' 			=> 'dropdown',
                'heading' 		=> __('Add box style', 'pix-opts'),
                'description' 		=> __('Add white box for each post.', 'pix-opts'),
                'dependency' => array(
                    "element" => "blog_style",
                    "value" => array('', 'padding', 'default', 'with-padding')
                ),
            ...
            array (
                ...
                'type' 			=> 'dropdown',
                'heading' 		=> __('Use dark mode', 'pix-opts'),
                'description' 		=> __('Inverse colors.', 'pix-opts'),
                'admin_label'	=> false,
                'dependency' => array(
                    "element" => "blog_style",
                    "value" => array('', 'padding', 'default', 'with-padding')
