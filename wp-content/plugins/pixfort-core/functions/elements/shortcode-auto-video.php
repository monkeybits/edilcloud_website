...
vc_map( array (
    'base' 			=> 'pix_auto_video',
    'name' 			=> __('Auto video', 'pix-opts'),
    'category' 		=> __('pixfort', 'pix-opts'),
    "weight"	=> "1000",
    'class'         => 'pixfort_element',
    'icon' 			=> PIX_CORE_PLUGIN_URI . 'functions/images/elements/auto-video.gif',
    'description' 	=> __('Use video that starts automatically in your page', 'pix-opts'),
    'params' 		=> array_merge(
        array (
            ...
            array(
                'type' => 'textfield',
                'heading' => esc_html__( 'MP4 Video URL', 'js_composer' ),
                ...
                array (
                    'param_name' 	=> 'poster',
                    'type' 			=> 'attach_image',
                    'heading' 		=> __('Poster image', 'pix-opts'),
                    'description' 		=> __('Image to be shown before loading the video', 'pix-opts'),
                    'admin_label'	=> false,
                ),
                ...
                array (
                    'param_name' 	=> 'img_div',
                    'type' 			=> 'dropdown',
                    'heading' 		=> __('Video inside a container', 'pix-opts'),
                ...
                array (
                    ...
                    'type' 			=> 'dropdown',
                    'heading' 		=> __('Video Scale In effect', 'pix-opts'),
