...
vc_map( array (
    'base' 			=> 'clients',
    'name' 			=> __('Clients', 'pix-opts'),
    'category' 		=> __('pixfort', 'pix-opts'),
    "weight"	=> "1000",
    'class'         => 'pixfort_element',
    'icon' 			=> PIX_CORE_PLUGIN_URI . 'functions/images/elements/clients.png',
    'description' 	=> __('Display customized logos', 'pix-opts'),
    'params' 		=> array (
        array (
            'param_name' 	=> 'in_row',
            'type' 			=> 'dropdown',
            'heading' 		=> __('Items in Row', 'pix-opts'),
            'description' 	=> __('Number of items in row. Recommended number: 3-6', 'pix-opts'),
            'admin_label'	=> true,
            'value' 		=> array(
                '1 Client'	            => '12',
                '2 Clients'				=> '6',
        ...
        array (
            'param_name' 	=> 'style',
            'type' 			=> 'dropdown',
            'heading' 		=> __('Additional hover effect', 'pix-opts'),
            'admin_label'	=> false,
            'value' 		=> array_flip(array(
        ...
        array (
            ...
            'type' 			=> 'dropdown',
            'heading' 		=> __('Add delay between items', 'pix-opts'),
            'admin_label'	=> false,
            'value' 		=> array_flip(array(
                ''			=> 'No',
                'yes'			=> 'Yes',
