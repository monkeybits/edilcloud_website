...
$h_tabs_params = array(
    ...
    array (
        ...
        'description' 	=> __('Select the style of the tabs.', 'pix-opts'),
        'admin_label'	=> false,
        'value'			=> array_flip(array(
...
$v_tabs_params = array(
    ...
    array (
        ...
        'type' 			=> 'textfield',
        'heading' 		=> __('Badge Text', 'pix-opts'),
        'admin_label'	=> true,
    ),
    ...
    array (
        ...
        'type' 			=> 'dropdown',
        'heading' 		=> __('Badge text color', 'pix-opts'),
        'admin_label'	=> false,
        'value' 		=> $colors,
        'std'           => 'primary',
        "dependency" => array(
    ...
    array (
        ...
        'type' 			=> 'colorpicker',
        'heading' 		=> __('Badge custom text color', 'pix-opts'),
        'admin_label'	=> false,
        "dependency" => array(
    ...
    array (
        ...
        'type' 			=> 'dropdown',
        'heading' 		=> __('Badge Background color', 'pix-opts'),
        'admin_label'	=> false,
        'value' 		=> $bg_colors,
        'std'			=> 'primary-light',
        "dependency" => array(
    ...
    array (
        ...
        'type' 			=> 'colorpicker',
        'heading' 		=> __('Badge Custom Background Color', 'pix-opts'),
        'admin_label'	=> false,
        "dependency" => array(
    ...
    array (
        ...
        'type' 			=> 'dropdown',
        'heading' 		=> __('Badge text size', 'pix-opts'),
        'admin_label'	=> false,
        'value' 		=> array(
            __('H1','pix-opts') 	=> 'h1',
            __('H2','pix-opts')	    => 'h2',
    ...
    array (
        ...
        'type' 			=> 'textfield',
        'heading' 		=> __('Badge custom text Size', 'pix-opts'),
        'admin_label'	=> false,
        "dependency" => array(
    ...
    array(
      ...
      array (
          ...
          'type' 			=> 'dropdown',
          'heading' 		=> __('Menu Position', 'pix-opts'),
          'admin_label'	=> false,
          'value' 		=> array(
      ...
      array (
          ...
          'type' 			=> 'textfield',
          'heading' 		=> __('Padding before menu', 'pix-opts'),
          "std"           => "20px",
          "description" => __( "Please input the value (with the unit: px,.. etc).", "pix-opts"),
          'admin_label'	=> false,
      ),
...
vc_map( array(
  ...
  'description' 	=> __('Create custom vertical tabs styles', 'pix-opts'),
...
vc_map( array(
  ...
  'description' 	=> __('Create custom horizontal tabs styles', 'pix-opts'),
  "is_container" => true,
'as_parent' => array(
	'only' => 'pix_content_tab',
),
...
vc_map(array(
	'name' => esc_html__( 'Pix Tab', 'js_composer' ),
	...
	'params' => array(
        ...
        array (
            ...
            'type' 			=> 'dropdown',
            'heading' 		=> __('Transition', 'pix-opts'),
            'description' 	=> __('Select the transition of the tab.', 'pix-opts'),
            'admin_label'	=> false,
            'value'			=> array_flip(array(
                ''			=> 'None',
                'fade'			=> 'Fade',
