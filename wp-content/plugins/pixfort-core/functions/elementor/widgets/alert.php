...
class Pix_Eor_Alert extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-alert-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/alert.js', [ 'elementor-frontend' ], PLUGIN_VERSION, true );
   	}
	...
	public function get_script_depends() {
	     return [ 'pix-global', 'pix-alert-handle' ];
	  }
