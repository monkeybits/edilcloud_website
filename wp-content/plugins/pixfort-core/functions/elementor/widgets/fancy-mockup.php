...
class Pix_Eor_Fancy_Mockup extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-fancy-mockup-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/fancy-mockup.js', [ 'elementor-frontend' ], '1.0.0', true );
   	}
	...
	public function get_script_depends() {
	     return [ 'pix-global', 'pix-fancy-mockup-handle' ];
	  }
