...
class Pix_Eor_Animated_Heading extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-animated-heading-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/animated-heading.js', [ 'elementor-frontend' ], PLUGIN_VERSION, true );
   	}
	...
	public function get_script_depends() {
	     return [ 'pix-global', 'pix-animated-heading-handle' ];
	  }
