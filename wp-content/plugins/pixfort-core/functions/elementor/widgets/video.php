...
class Pix_Eor_Video extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'pix-video-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/video.js', [ 'elementor-frontend' ], '1.0.0', true );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'image',
			[
				'label' => __( 'Placeholder Image', 'plugin-name' ),
		...
		$this->add_control(
			'custom_bg_color',
			[
				'label' => __( 'Text Icon color', 'plugin-name' ),
	...
	public function get_script_depends() {
		return [ 'pix-global', 'pix-video-handle' ];
	}
