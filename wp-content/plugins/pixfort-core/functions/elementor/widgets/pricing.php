...
class Pix_Eor_Pricing extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-pricing-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/pricing.js', [ 'elementor-frontend' ], '1.0.0', true );
   	}
	...
	protected function _register_controls() {
        ...
        $this->add_control(
			'box_color',
			[
				'label' => __( 'Box color', 'plugin-name' ),
		...
		$this->add_control(
			'box_custom_color',
			[
				'label' => __( 'Custom box color', 'plugin-name' ),
...
pix_get_elementor_effects($this);
		...
		$this->start_controls_section(
			'pix_section_badge',
			[
				'label' => __( 'Badge settings', 'plugin-name' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Price & Subtitle', 'plugin-name' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT
			]
		);
		...
		$this->add_control(
			'price_custom_color',
			[
				'label' => __( 'Custom Price color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
					'price_color' => 'custom',
	...
	public function get_script_depends() {
	     return [ 'pix-global', 'pix-pricing-handle' ];
	  }
