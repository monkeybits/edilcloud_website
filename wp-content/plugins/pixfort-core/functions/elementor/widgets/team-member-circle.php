...
class Pix_Eor_Team_Member_Circle extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      // wp_register_script( 'pix-team-member-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/team-member.js', [ 'elementor-frontend' ], '1.0.0', true );
   	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Description format', 'plugin-name' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
				'condition' => [
					'description!' => '',
				],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Description Title color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
		...
		$this->start_controls_section(
			'pix_section_icons',
			[
				'label' => __( 'Icons format', 'plugin-name' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'items_custom_color',
			[
				'label' => __( 'Description icons color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '#333',
				'condition' => [
					'items_color' => 'custom',
	...
	protected function render() {
		...
		echo sc_pix_team_member_circle($settings);
	}
