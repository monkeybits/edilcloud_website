...
class Pix_Eor_Circles extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-circles-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/circles.js', [ 'elementor-frontend' ], '1.0.0', true );
   	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'effect',
			[
				'label' => __( 'Circles Effect', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					"" => "Default",
					"1"       => "Small shadow",
		...
		$this->add_control(
			'hover_effect',
			[
				'label' => __( 'Circles Hover Style', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					""       => "None",
		...
		$this->add_control(
			'circles_size',
			[
				'label' => __( 'Circles Size', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => array(
		...
		$this->add_control(
			'circles_align',
			[
				'label' => __( 'Circles Align', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => array(
	...
	public function get_script_depends() {
	     return [ 'pix-global', 'pix-circles-handle' ];
	  }
