...
class Pix_Eor_Countdown extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-countdown-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/countdown.js', [ 'elementor-frontend' ], '1.0.0', true );
   	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'numbers_color',
			[
				'label' => __( 'Numbers color', 'plugin-name' ),
		...
		$this->add_control(
			'numbers_size',
			[
				'label' => __( 'Numbers size', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => array_flip(array(
					__('H1','pix-opts') 	=> 'h1',
					__('H2','pix-opts')	    => 'h2',
	...
	public function get_script_depends() {
	     return [ 'pix-global', 'pix-countdown-handle' ];
	  }
