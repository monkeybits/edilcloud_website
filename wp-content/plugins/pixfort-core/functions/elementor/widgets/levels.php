...
class Pix_Eor_Levels extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
		...
		// wp_register_script( 'pix-cta-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/cta.js', [ 'elementor-frontend' ], '1.0.0', true );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'items_count',
			[
				'label' => __( 'Items per Line', 'plugin-name' ),
		...
		$this->add_control(
			'active_custom_color',
			[
				'label' => __( 'Active custom color', 'plugin-name' ),
