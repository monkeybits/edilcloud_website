...
class Pix_Eor_Feature_List extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-feature-list-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/feature-list.js', [ 'elementor-frontend' ], '1.0.0', true );
   	}
	...
	public function get_script_depends() {
	     return [ 'pix-global', 'pix-feature-list-handle' ];
	  }
