...
class Pix_Eor_Feature extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'pix-feature-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/feature.js', [ 'elementor-frontend' ], '1.0.0', true );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'media_type',
			[
				'label' => __( 'Use image or icon', 'plugin-name' ),
	...
	public function get_script_depends() {
		return [ 'pix-global', 'pix-feature-handle' ];
	}
