...
class Pix_Eor_Shop_Category extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-shop-category-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/shop-category.js', [ 'elementor-frontend' ], '1.0.0', true );
   	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'pix_section_count',
			[
				'label' => __( 'Count badge format', 'plugin-name' ),
	...
	protected function render() {
		...
		echo sc_pix_shop_category($settings);
	}
	...
	public function get_script_depends() {
	     return [ 'pix-global', 'pix-shop-category-handle' ];
	  }
