...
class Pix_Eor_Numbers extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'pix-numbers-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/numbers.js', [ 'elementor-frontend' ], '1.0.0', true );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'title_section',
			[
				'label' => __( 'Top Text Format', 'plugin-name' ),
		...
		$this->add_control(
			'before_format',
			[
				'label' => __( 'Before text format', 'plugin-name' ),
		...
		$this->add_control(
			'number_format',
			[
				'label' => __( 'Number format', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::RAW_HTML,
				'content_classes' => 'your-class',
			]
		);
		...
		$this->add_control(
			'after_format',
			[
				'label' => __( 'After text format', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::RAW_HTML,
				'content_classes' => 'your-class',
			]
		);
		...
		$this->add_control(
			'content_position',
			[
				'label' => __( 'Content position', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => array_flip(array(
	...
	public function get_script_depends() {
		return [ 'pix-global', 'pix-numbers-handle' ];
	}
