...
class Pix_Eor_Photo_Stack extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-photo-stack-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/photo-stack.js', [ 'elementor-frontend' ], '1.0.0', true );
   	}
	...
	public function get_script_depends() {
	     return [ 'pix-global', 'pix-photo-stack-handle' ];
	  }
