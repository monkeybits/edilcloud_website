...
class Pix_Eor_Heading extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      // wp_register_script( 'pix-alert-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/alert.js', [ 'elementor-frontend' ], '1.0.0', true );
   	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'image',
			[
				'label' => __( 'Use image as text color', 'plugin-name' ),
