...
class Pix_Eor_Testimonial extends Widget_Base {

	public function __construct($data = [], $args = null) {
      parent::__construct($data, $args);

      wp_register_script( 'pix-testimonial-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/testimonial.js', [ 'elementor-frontend' ], '1.0.0', true );
   	}

	public function get_name() {
		return 'pix-testimonial';
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Enter the Content', 'elementor' ),
				'default' => '',
			]
		);
		...
		$this->add_control(
			'circle_color',
			[
				'label' => __( 'Circle color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->start_controls_section(
			'pix_section_name',
			[
				'label' => __( 'Name format', 'plugin-name' ),
		...
		$this->add_control(
			'name_color',
			[
				'label' => __( 'Name color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => array_flip($colors),
		...
		$this->add_control(
			'name_custom_color',
			[
				'label' => __( 'Custom Name color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
					'name_color' => 'custom',
		...
		$this->add_control(
			'name_size',
			[
				'label' => __( 'Name size', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => array_flip(array(
					__('H1','pix-opts') 	=> 'h1',
 				   __('H2','pix-opts')	    => 'h2',
		...
		$this->add_control(
			'text_custom_color',
			[
				'label' => __( 'Text Title color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
					'text_color' => 'custom',
		...
		$this->add_control(
			'text_size',
			[
				'label' => __( 'Text font size', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					''			=> 'Default (16px)',
	                'text-xs'		=> '12px',
	...
	protected function render() {
		...
		echo sc_pix_testimonial($settings);
	}
	...
	public function get_script_depends() {
	     return [ 'pix-global', 'pix-testimonial-hamdle' ];
	  }
