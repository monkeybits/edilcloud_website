...
class Pix_Eor_Auto_Video extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-auto-video-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/auto-video.js', [ 'elementor-frontend' ], PLUGIN_VERSION, true );
   	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'poster',
			[
				'label' => __( 'Poster image', 'plugin-name' ),
	...
	public function get_script_depends() {
	     return [ 'pix-global', 'pix-auto-video-handle' ];
	  }
