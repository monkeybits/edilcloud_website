...
class Pix_Eor_Icon extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'pix-icon-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/icon.js', [ 'elementor-frontend' ], '1.0.0', true );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'media_type',
			[
				'label' => __( 'Icon type', 'plugin-name' ),
		...
		$this->add_control(
			'link_type',
			[
				'label' => __( 'Link type', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => array(
	                'link'	=> 'Link',
	                'popup'	=> 'Popup',
		...
		$this->add_control(
			'embed_code',
			[
				'label' => __( 'Embed Code', 'plugin-name' ),
		...
		$this->add_control(
			'aspect',
			[
				'label' => __( 'Aspect ratio', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => array_flip(array(
		...
		$this->add_control(
			...
			$this->start_controls_section(
				'icon_section',
				[
					'label' => __( 'Icon format', 'plugin-name' ),
			...
			$this->add_control(
				...
				[
					'label' => __( 'Custom Icon Background Color', 'plugin-name' ),
					'type' => \Elementor\Controls_Manager::COLOR,
					'default' => '',
					'condition' => [
						'icon_color' => 'custom',
			...
			$this->start_controls_section(
				'image_section',
				[
					'label' => __( 'Image format', 'plugin-name' ),
					'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
					'condition' => [
	...
	public function get_script_depends() {
		return [ 'pix-global', 'pix-icon-handle' ];
	}
