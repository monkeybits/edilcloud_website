...
class Pix_Eor_Vertical_Tabs extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-text-tabs-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/tabs.js', [ 'elementor-frontend' ], '1.0.0', true );
   	}
	...
	protected function _register_controls() {
        ...
        $this->add_control(
			'menu_position',
			[
				'label' => __( 'Menu Position', 'plugin-name' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Custom Content color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
