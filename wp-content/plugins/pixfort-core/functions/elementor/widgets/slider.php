...
class Pix_Eor_Slider extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'pix-slider-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/slider.js', [ 'elementor-frontend' ], '1.0.0', true );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'fields' => [
					...
					[
						'name'	=> 'btn_popup_id',
			            'label' => __( 'Open Popup instead of link', 'plugin-name' ),
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => __( 'Content format', 'plugin-name' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Content Text color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
		...
		$this->add_control(
			'content_size',
			[
				'label' => __( 'Content size', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					''			=> 'Default (16px)',
					'text-xs'		=> '12px',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Text custom color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
		...
		$this->add_control(
			'btn_size',
			[
				'label' => __( 'Button Size', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					"sm"       => "Small",
					"normal"       => "Normal",
		...
		$this->add_control(
			'btn_hover_effect',
			[
				'label' => __( 'Button Shadow Hover Style', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					""       => "None",
		...
		$this->add_control(
			...
			[
				'label' => __( 'Button Hover Animation', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					""       => "None",
					"1"       => "Fly Small",
		...
		// 		'options'	=> pix_get_pixicons_array(),
		// 		'default' => '',
		// 	]
		// );
		...
		$this->add_control(
			'btn_icon_position',
			[
				'label' => __( 'Icon position', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					""            => "Before text (left)",
		...
		$this->add_control(
			'btn_div',
			[
				'label' => __( 'Button inside a container', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					'' 		=> 'Disabled',
	...
	public function get_script_depends() {
		return [ 'pix-global', 'pix-slider-handle' ];
	}
