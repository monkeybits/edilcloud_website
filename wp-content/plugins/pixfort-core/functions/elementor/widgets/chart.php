...
class Pix_Eor_Chart extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-chart-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/chart.js', [ 'elementor-frontend' ], '1.0.0', true );
   	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'color2',
			[
				'label' => __( 'Second Chart color (Optional)', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '',
			]
		);
		$this->add_control(
			'color3',
			[
				'label' => __( 'Third Chart color (Optional)', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '',
			]
		);
		$this->add_control(
			'track_color',
			[
				'label' => __( 'Track background color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '',
			]
		);
		...
		$this->start_controls_section(
			'percent_section',
			[
				'label' => __( 'Percent format', 'plugin-name' ),
		...
		$this->add_control(
			'p_color',
			[
				'label' => __( 'Percent color', 'plugin-name' ),
		...
		$this->add_control(
			'p_custom_color',
			[
				'label' => __( 'Custom Percent color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
					'p_color' => 'custom',
		...
		$this->add_control(
			'p_size',
			[
				'label' => __( 'Percent size', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => array_flip(array(
					__('H1','pix-opts') 	=> 'h1',
 				   __('H2','pix-opts')	    => 'h2',
	...
	public function get_script_depends() {
	     return [ 'pix-global', 'pix-chart-handle' ];
	  }
