...
class Pix_Eor_Sliding_Text extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      ...
      wp_register_script( 'pix-sliding-text-handle', PIX_CORE_PLUGIN_URI.'/functions/elementor/js/sliding-text.js', [ 'elementor-frontend' ], '1.0.0', true );
   	}
	...
	public function get_script_depends() {
	     return [ 'pix-global', 'pix-sliding-text-handle' ];
	  }
