...
class pix_promo_box extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            __('PixFort Promo Box', 'pix_widget_domain'),
            // Widget description
            array( 'description' => __( 'Promo Box widget', 'pix_widget_domain' ), )
        );
    ...
    public function form( $instance ) {
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = __( 'Promo Box', 'pix_widget_domain' );
        }
        if ( isset( $instance[ 'heading' ] ) ) {
            $heading = $instance[ 'heading' ];
        }else {
            $heading = __( 'Promo box heading', 'pix_widget_domain' );
        }
        ...
        if ( isset( $instance[ 'link_text' ] ) ) {
            ...
            $link_text = __( 'Check it out', 'pix_widget_domain' );
        }
