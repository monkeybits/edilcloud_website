...
if( ! function_exists( 'sc_pix_testimonial' ) ){
	...
	function sc_pix_testimonial( $attr, $content = null ){
		...
		// if(empty($title_size)||$title_size=='custom'){
		// 	$title_tag = 'h5';
			...
			$testimonial .= '<div class="card pix-p-10 '.$rounded_box.'">';
				// if( $value['link'] ) $output .= '<a target="_blank" href="'. $value['link'] .'" title="'. $value['title'] .'">';
					$testimonial .= '<div class="card-body">';
						if(!empty($text)) $testimonial  .= '<p class="card-text '.$text_classes.'" '.$text_style.'>'. do_shortcode($text).'</p>';
						// $testimonial .= '<p class="">'. do_shortcode($text) .'</p>';
						$testimonial .= '<div class="d-flex">';
							...
							// $testimonial .= '<h6 class="text-dark-opacity-8 font-weight-bold mx-3 animate-in" data-anim-type="fade-in-left" data-anim-delay="400">Name</h6>';
							...
							// $testimonial .= '<span class="text-dark-opacity-6 pb-0 mx-3 mb-0 text-sm animate-in" data-anim-type="fade-in-left" data-anim-delay="500">Title</span>';
							$testimonial .= '</div>';
						$testimonial .= '</div>';
					$testimonial .= '</div>';
