	...
	function sc_pix_img( $attr, $content = null ){
        ...
        if(!empty($image)){
            ...
            if($link){
                ...
                $output .= '<div class="'.$class_names.' '.$main_width.' '.$rounded_img.'"  '.$jarallax.'>';
                    ...
                    if(!empty($imgSrc)){
                        if(empty($imgSrcset)){
                            $output .= '<img class="card-img2 pix-img-elem '.$rounded_img.'  h-1002" '.$inline_style.' src="'.$imgSrc.'" alt="'. $alt .'" />';
                        }else{
                            $output .= '<img class="card-img2 pix-img-elem '.$rounded_img.'  h-1002" '.$inline_style.' srcset="'.$imgSrcset.'" sizes="'.$imgSizes.'" src="'.$imgSrc.'" alt="'. $alt .'" />';
                        }
                    }
