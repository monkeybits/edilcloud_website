            ...
            $menu .= '<div class="'.$is_sticky.'" style="top:110px;">';
                ...
                foreach ( $attrs as $key => $item ) {
                        ...
                        $menu .= '<div class="nav-item mx-0">';
                            ...
                            $menu .= '<a class="nav-link pix-tabs-btn text-24 py-2 mb-2 '.$position.' '.$bold.' '.$italic.' '.$secondary_font.'" data-id="'. $item['tab_id'] .'" id="pix-tab-btn-'. $item['tab_id'] .'" role="tab" data-toggle="pill" href="#pix-tab-'. $item['tab_id'] .'"  aria-controls="pix-tab-'. $item['tab_id'] .'" aria-selected="true"><strong>'.$icon_html. $title .'</strong></a>';
                        $menu .= '</div>';
                }
                $menu .= '</div>';
            $menu .= '</div>';
