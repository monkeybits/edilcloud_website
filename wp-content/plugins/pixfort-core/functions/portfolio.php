...
function pix_portfolio_post_type()
{
	...
	if(function_exists('pix_get_option')){
		if(!empty(pix_get_option('portfolio-slug'))){
			$portfolio_item_slug = pix_get_option('portfolio-slug');
		}
	}
	...
	$labels = array(
		...
		'singular_name' 		=> __('Portfolio item','pix-opts'),
		'add_new' 				=> __('Add New','pix-opts'),
		'add_new_item' 			=> __('Add New Portfolio item','pix-opts'),
		'edit_item' 			=> __('Edit Portfolio item','pix-opts'),
		'new_item' 				=> __('New Portfolio item','pix-opts'),
		'view_item' 			=> __('View Portfolio item','pix-opts'),
		'search_items' 			=> __('Search Portfolio items','pix-opts'),
		'not_found' 			=> __('No portfolio items found','pix-opts'),
		'not_found_in_trash' 	=> __('No portfolio items found in Trash','pix-opts'),
		'parent_item_colon' 	=> ''
	  );
	...
	register_taxonomy( 'portfolio-types', 'portfolio', array(
		'hierarchical' 			=> true,
		'label' 				=>  __( 'Portfolio categories', 'pix-opts' ),
		'singular_label' 		=>  __( 'Portfolio category', 'pix-opts' ),
		'rewrite'				=> true,
		'query_var' 			=> true,
		'public'                     => true,
        'show_ui'                    => true,
...
function pix_portfolio_edit_columns($columns)
{
	$newcolumns = array(
		...
		"portfolio_thumbnail" 	=> __('Thumbnail','pix-opts'),
		"title" 				=> 'Title',
		"portfolio_types" 		=> __('Categories','pix-opts'),
		"portfolio_order" 		=> __('Order','pix-opts'),
	);
...
function pix_portfolio_meta_add(){
	...
	$pix_page_meta_box = array(
		...
		'fields'	=> array(
			...
			// array(
			// 	'id' 		=> 'pix-post-master-slider',
			// 	'type' 		=> 'select',
			// 	'title' 	=> __('Master Slider 2', 'pix-opts'),
			// 	'sub_desc' 	=> __('Select Main slider for the page.', 'pix-opts'),
			// 	'desc' 		=> __('Select one from the list of available <a target="_blank" href="admin.php?page=masterslider">Master Sliders</a>', 'pix-opts'),
			// 	'options' 	=> pix_get_master_sliders(),
			// ),
			...
			// 	'id' 		=> 'pix-post-slider',
			// 	'type' 		=> 'select',
			// 	'title' 	=> __('Revolution Slider', 'pix-opts'),
			// 	'sub_desc' 	=> __('Select Main slider for the page.', 'pix-opts'),
			// 	'desc' 		=> __('Select one from the list of available <a target="_blank" href="admin.php?page=revslider">Revolution Sliders</a>', 'pix-opts'),
			// 	'options' 	=> pix_get_rev_sliders(),
			// ),

			// array(
			// 	'id' 		=> 'pix-post-slider-layer',
			// 	'type' 		=> 'select',
			// 	'title' 	=> __('Layer Slider', 'pix-opts'),
			// 	'sub_desc' 	=> __('Select Main slider for the page.', 'pix-opts'),
			// 	'desc' 		=> __('Select one from the list of available <a target="_blank" href="admin.php?page=layerslider">Layer Sliders</a>', 'pix-opts'),
			// 	'options' 	=> pix_get_layer_sliders(),
			// ),

			array(
				'id'		=> 'pix-post-hide-content',
				'type'		=> 'switch',
				'title'		=> __('Hide The Content', 'pix-opts'),
				'sub_desc'	=> __('Hide the content from the WordPress editor.', 'pix-opts'),
				'desc'		=> __('<strong>Turn it ON if you build content using Content Builder</strong>. Use the Content item if you want to display the Content from editor within the Content Builder.', 'pix-opts'),
			...
			array(
				...
				'type' 		=> 'select',
				'title' 	=> __('Custom Layout', 'pix-opts'),
				'desc' 		=> __('Custom Layout overwrites Theme Options', 'pix-opts'),
				'options' 	=> $layouts,
			),
			...
			// 	'type' 		=> 'select',
			// 	'title' 	=> __('Custom Mobile Menu', 'pix-opts'),
			// 	'options' 	=> $aMenus,
			// ),
			...
			// 	'id' 		=> 'pix-post-layout',
			// 	'type' 		=> 'select',
			// 	'title' 	=> __('Layout', 'pix-opts'),
			// 	'sub_desc' 	=> __('Select layout for this page', 'pix-opts'),
			// 	'options' 	=> array(
			...
			array(
				'id' 		=> 'pix-post-css',
				'type' 		=> 'textarea',
				'title' 	=> __('Custom CSS', 'pix-opts'),
				'desc' 		=> __('Paste your custom CSS code for this page.', 'pix-opts'),
			),
