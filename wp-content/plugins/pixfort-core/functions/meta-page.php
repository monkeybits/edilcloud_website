...
function pix_page_meta_add(){
	...
	$pix_page_meta_box_3 = array(
		...
		'fields'	=> array(
			...
			// 	'id'		=> 'pix-hide-title',
			// 	'type'		=> 'select',
			// 	'title'		=> __('Hide The Title', 'pix-opts'),
			// 	'sub_desc'	=> __('Hide page title.', 'pix-opts'),
			...
			array(
				...
				'type'		=> 'select',
				'title'		=> __('Hide Top Padding', 'pix-opts'),
				'sub_desc'	=> __('Hide the padding before page content (under the header).', 'pix-opts'),
				//'desc'		=> __('<strong>Turn it ON if you build content using Content Builder</strong>. Use the Content item if you want to display the Content from editor within the Content Builder.', 'pix-opts'),
				'options'	=> array('1' => 'Yes', '0' => 'No'),
				'std'		=> '0'
			),
			...
			array(
				...
				'type'		=> 'select',
				'title'		=> __('Hide top area (Intro)', 'pix-opts'),
				'sub_desc'	=> __('Hide the area under header).', 'pix-opts'),
				//'desc'		=> __('<strong>Turn it ON if you build content using Content Builder</strong>. Use the Content item if you want to display the Content from editor within the Content Builder.', 'pix-opts'),
				'options'	=> array(
					'1' => 'Yes',
					'0' => 'No',
			...
			array(
				...
				'type'		=> 'switch',
				'title'		=> __('Enable section slides', 'pix-opts'),
				// 'sub_desc'	=> __('Hide the area under header (only in boxed header layout).', 'pix-opts'),
				// 'desc'		=> __('<strong>Turn it ON if you build content using Content Builder</strong>. Use the Content item if you want to display the Content from editor within the Content Builder.', 'pix-opts'),
				'options'	=> array('1' => 'On', '0' => 'Off'),
				'std'		=> '0'
			),
			array(
				...
				'type'		=> 'switch',
				'title'		=> __('Dark section slides navigation', 'pix-opts'),
				// 'sub_desc'	=> __('Hide the area under header (only in boxed header layout).', 'pix-opts'),
				// 'desc'		=> __('<strong>Turn it ON if you build content using Content Builder</strong>. Use the Content item if you want to display the Content from editor within the Content Builder.', 'pix-opts'),
				'options'	=> array('1' => 'On', '0' => 'Off'),
				'std'		=> '0'
			...
			array(
				'id' 		=> 'pix-page-header',
				'type' 		=> 'select',
				'title' 	=> __('Custom Header', 'pix-opts'),
				'options' 	=> $headers,
			),
			array(
				'id' 		=> 'pix-page-footer',
				'type' 		=> 'select',
				'title' 	=> __('Custom Footer', 'pix-opts'),
				'options' 	=> $footers,
			),
			array(
				'id' 		=> 'pix-page-sidebar',
				'type' 		=> 'select',
				'title' 	=> __('Custom Sidebar', 'pix-opts'),
				'sub_desc'	=> __('Select if you choose sidebar template for the page.', 'pix-opts'),
				'options' 	=> $sidebars,
			),
			array(
				'id' 		=> 'pix-page-sidebar-sticky',
				'type' 		=> 'select',
				'title' 	=> __('Sidebar Sticky', 'pix-opts'),
				// 'sub_desc'	=> __('Select if you choose sidebar template for the page.', 'pix-opts'),
				'options' 	=> array(
	                ''   => "Theme default",
