...
function pixfort_demo_headers(){
    ...
    $demo = array(
        ...
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/fast/fast-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/onepage/onepage-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/finance/finance-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/software/software-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/saas/saas-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/startup/startup-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/marketing/marketing-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/kb/kb-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/services/services-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/event/event-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/slides/slides-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/medical/medical-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/cryptocurrency/cryptocurrency-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/bold/bold-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/creative/creative-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/ebook/ebook-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/landing/landing-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/restaurant/restaurant-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/ecommerce/ecommerce-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/foundation/foundation-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/construction/construction-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/business/business-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/corporate/corporate-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/product/product-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/coronavirus/coronavirus-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/personal/personal-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/influencer/influencer-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/photography/photography-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/app/app-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/agency/agency-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/beauty/beauty-header.xml',
    ...
    $demo = array(
        ...
        'categories'                   => array( 'Headers' ),
        'import_file_url'            => 'https://pixfort-space.sfo2.digitaloceanspaces.com/wordpress/essentials/demos/blogger/blogger-header.xml',
