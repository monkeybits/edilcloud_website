		...
		*/
		...
		<div class="d-flex align-items-center pix-pt-20">
			...
			<div class="pix-pl-10 align-self-stretch d-flex">
				...
				?>
				<a href="<?php echo esc_attr( $add_link ); ?>" class="pix-add-to-cart text-body-default" data-product_id="<?php echo esc_attr( $post->ID ); ?>" data-name="<?php echo esc_attr( $product->get_name() );?>" data-img="<?php echo esc_attr( $image ); ?>"><span class="btn-icon text-18 text-body-default pixicon-bag-2 align-self-center"></span></a>
			</div>
		</div>
	</div>
</li>
