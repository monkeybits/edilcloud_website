				...
				<div class="w-100">
					<div class="d-flex align-items-center">
						...
						<div class="pix-pl-10 align-self-stretch d-flex">
							...
							?>
							<a href="<?php echo esc_url( $add_link ); ?>" class="pix-add-to-cart" data-product_id="<?php echo esc_attr( $post->ID ); ?>" data-name="<?php echo esc_attr( $product->get_name() );?>" data-img="<?php echo esc_attr( $image ); ?>">
								<span class="btn-icon text-18 text-body-default2 text-light-opacity-7 pixicon-bag-2 align-self-center"></span>
							</a>
						</div>
					</div>
				</div>
