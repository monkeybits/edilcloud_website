		...
		<div class="pix-p-20">
			...
			<div class="d-flex align-items-center">
				...
				<div class="pix-pl-10 flex-fill text-right align-self-stretch2 d-flex2">
					...
					?>
					<span data-preview-link="<?php echo esc_html( $link ); ?>" class="text-18 d-inline-block pix-preview-loop-icon pix-product-preview align-self-center text-body-default"><?php echo pix_load_inline_svg(get_template_directory().'/inc/assets/preview.svg') ?></span>
				</div>
			</div>
			<div class="">
			<?php
		...
		*/
		...
		<div class="d-flex align-items-center pix-p-20">
			...
			<div class="pix-pl-10 align-self-stretch d-flex">
				...
				?>
				<a href="<?php echo esc_attr( $add_link ); ?>" class="pix-add-to-cart" data-product_id="<?php echo esc_attr( $post->ID ); ?>" data-name="<?php echo esc_attr( $product->get_name() );?>" data-img="<?php echo esc_attr( $image ); ?>"><span class="btn-icon text-18 text-body-default pixicon-bag-2 align-self-center"></span></a>
			</div>
		</div>
	</div>
</li>
