...
<div class="product_meta">
	...
	<?php if ( wc_product_sku_enabled() && ( $product->get_sku() || $product->is_type( 'variable' ) ) ) : ?>
		<span class="sku_wrapper text-sm"><span class="text-heading-default font-weight-bold"><?php esc_html_e( 'SKU:', 'essentials' ); ?></span> <span class="sku"><?php echo ( $sku = $product->get_sku() ) ? $sku : esc_html__( 'N/A', 'essentials' ); ?></span></span>
