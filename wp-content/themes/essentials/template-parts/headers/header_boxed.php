     ...
     <div class="<?php echo esc_attr( $cont_class ); ?>">
         ...
         if($stack_data){
          ...
          ?>
               ...
               <?php endif; ?>
              <div class="pix-header-desktop pix-header-stack bg-<?php echo esc_attr( $background ); ?> pix-header-box-part">
                  ...
                  <div class="row">
                      ...
                      $display_col = sizeof($stack_val->stack_1->val)>0? 'pix-header-min-height':'';
                       ?>
                      <div class="col-12 col-lg-4 column text-center <?php echo esc_attr( $display_col ); ?> text-md-left justify-content-md-start  py-md-0 d-flex align-items-center">
          				<?php
                      ...
                      $display_col = sizeof($stack_val->stack_2->val)>0? 'pix-header-min-height':'';
                       ?>
                      <div class="col-12 col-lg-4 column text-center <?php echo esc_attr( $display_col ); ?> text-md-right2 justify-content-md-center py-md-0 d-flex align-items-center">
          				<?php
                      ...
                      $display_col = sizeof($stack_val->stack_3->val)>0? 'pix-header-min-height':'';
                       ?>
                      <div class="col-12 col-lg-4 column text-center <?php echo esc_attr( $display_col ); ?> text-md-right justify-content-md-end py-md-0 d-flex align-items-center">
          				<?php
