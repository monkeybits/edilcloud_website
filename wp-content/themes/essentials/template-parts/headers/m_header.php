...
if(!empty($m_header_data->val)):
    ...
    <header id="mobile_head" class="pix-header pix-header-mobile d-inline-block pix-header-normal pix-scroll-shadow sticky-top header-scroll2 bg-<?php echo esc_attr( $background ); ?>">
         <div class="container">
