...
if(!empty($custom_background)){
 ...
 ?>
 <div class="pix-topbar position-relative pix-header-desktop pix-topbar-normal bg-<?php echo esc_attr( $background ) . ' '; ?> text-white sticky-top2 p-sticky" style="z-index:999;<?php echo esc_attr($custom_topbar_style); ?>" >
